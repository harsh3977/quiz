...
const app_1 = __importDefault(require("../app")); // Make sure this path points to your app instance
describe('Quiz API', () => {
    let quizId;
    ...
    it('should get the quiz by ID', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get(`/api/quiz/${quizId}`)
            .set('Accept', 'application/json');
    ...
    it('should submit an answer to a question', () => __awaiter(void 0, void 0, void 0, function* () {
        const answerData = {
            quizId,
            userId,
            questionId,
    ...
    it('should get the quiz results for a user', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
        ...
        expect(response.body.score).toBe(1); // Assuming the user answered correctly, score should be 1
    }));
});
